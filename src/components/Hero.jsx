    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
        ...
        <motion.div
          ...
          className="relative flex justify-center items-center min-h-[380px] md:min-h-[520px] order-1 md:order-2"
        >
          ...
          <div className="relative z-10">
            ...
            <motion.img
              ...
              transition={{ duration: 0.7, ease: "easeOut" }}
              className="h-[115%] object-contain drop-shadow-2xl transition-transform duration-300 hover:scale-105"
            />
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="mt-10 flex items-center gap-4 flex-wrap">
            ...
            <button
              ...
              className="px-8 py-3 rounded-full bg-[var(--color-secondary)] text-white font-medium hover:opacity-90 transition flex items-center gap-2 shadow-lg"
            >
              Enroll Now
